	...
	internal class VisualStudioCodeInstallation : VisualStudioInstallation
	{
		...
		public static bool TryDiscoverInstallation(string editorPath, out IVisualStudioInstallation installation)
		{
			...
			if (string.IsNullOrEmpty(editorPath))
				return false;
			var type_ = IsCandidateForDiscovery(editorPath);
			if (type_ == EditorCodeType.None)
				return false;
			...
			if (type_ == EditorCodeType.VisualStudioCode)
			...
			if (type_ == EditorCodeType.Trae)
				installation = new TraeCodeInstallation()
				{
					IsPrerelease = isPrerelease,
...
";
		...
		internal static void WriteAllTextFromJObject(string file, JSONNode node)
		{
		...
		internal static string TryFindWorkspace(string directory)
		{
		...
		internal static ProcessStartInfo ProcessStartInfoFor(string application, string arguments)
		{
#if UNITY_EDITOR_OSX
